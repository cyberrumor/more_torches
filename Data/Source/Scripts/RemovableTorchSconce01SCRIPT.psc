...
Bool Property StartsEmpty = TRUE Auto
{If this is TRUE the sconce will start empty.  Default = FALSE}

Bool Property TorchInSconce = FALSE Auto Hidden
{TRUE when there is a torch in the sonce, FALSE when there isn't.  Default = FALSE}
